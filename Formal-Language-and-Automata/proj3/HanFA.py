...
'''
CS322 project 1 as module HanFA
Python 3.5
'''
...
class HangeulAutomata(MealyMachine):
    ...
    def print_str_3x4(self, raw_str, MM_3x4):
        self.o_func.clear_hangeul()
        self.print_str(MM_3x4.token_translation(raw_str))

    def print_process_str_3x4(self, raw_str, MM_3x4):
        self.o_func.clear_hangeul()
        for idx in range(len(raw_str)):
            part_str = raw_str[:idx+1]
            self.print_str(MM_3x4.token_translation(part_str))
